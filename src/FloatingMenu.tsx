...
// class OldFloatingMenu extends React.Component {

//   pickItem = propAction => this.setState({ maxWidth: 0 }, this.props[propAction]);
...
//                 </Text>
//                 <TouchableOpacity
//                   style={[styles.confirmationBtn, { backgroundColor: this.props.appColor }]}
//                   onPress={() =>
//                     this.setState({ modalVisible: false }, this.props.onClearAllQuestions)
//                   }
//                 >
//                   <Text style={styles.confirmationBrnText}>CONFIRM</Text>
//                 </TouchableOpacity>
